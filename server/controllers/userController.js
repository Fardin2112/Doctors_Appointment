...
// make payment of appointment fees using razorpay
const paymentRazorpay = async (req,res) => {
    ...
    try {
      ...
      try {
        ...
        return res.json({ success: false, message: "Payment creation failed", error: error.message });
      }
    }
     catch (error) {
      console.log("Error in razor payment",error);
      return res.json({ success: false, message: error.message });
    }
}
